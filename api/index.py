...
async def entry(steamid:str,rankid:int,svg:bool=False):
    ...
    if not svg:
      ...
      <div xmlns="http://www.w3.org/1999/xhtml"><iframe class="csgo-stat-box" src="https://csgo.plugin.learningman.top/api?steamid={}&rankid={}" frameborder="0"></iframe></div></foreignObject>
